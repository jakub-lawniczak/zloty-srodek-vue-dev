<template>
    <svg
        ...
        style="enable-background:new 0 0 459.904 459.904;"
        xml:space="preserve"
    >
        <g>
            <g>
                <path
                    d="M123.465,168.28h46.543v138.07c0,14.008,11.358,25.352,25.352,25.352h69.2c13.993,0,25.352-11.343,25.352-25.352V168.28
            ...
            <g>
                <path
                    d="M437.036,220.029c-12.617,0-22.852,10.237-22.852,22.867v95.615c0,28.643-23.317,51.944-51.961,51.944H97.679
